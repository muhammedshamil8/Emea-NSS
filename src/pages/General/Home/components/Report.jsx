...
function Report() {
  ...
  return (
    <div className='relative bg-[#CABBE2]/25'>
      ...
      <div className=' w-full  pt-20 p-6   sm:p-16 flex flex-col-reverse sm:flex-row gap-4 max-w-[1300px] mx-auto'>
        <div className='flex flex-col gap-4 sm:w-1/2 justify-center'>
          <h1 className='text-2xl text-left text-[#332C6F] font-semibold underline underline-offset-2'>Reports</h1>
          ...
          <button className='bg-[#FF4C5A] max-w-fit text-white rounded-md px-3 py-1.5 text-sm transition-all ease-in-out hover:shadow-xl hover:bg-[#f03e4d]' onClick={handleClick}>View Reports</button>
        </div>
