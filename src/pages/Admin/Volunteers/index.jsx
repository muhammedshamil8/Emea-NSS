    ...
    <section className="p-4 min-h-screen">
      ...
      <div className="mb-4 flex justify-between items-center flex-col gap-4 sm:flex-row-reverse">
        ...
        <Input
          ...
          className="flex-1 mr-4 max-w-[700px] mx-auto mb-6"
        />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4">
        {loading ? (
          ...
          filteredVolunteers.map(volunteer => (
            <div key={volunteer.id} className="border p-4 rounded-lg shadow-md bg-white max-w-[300px] mx-auto w-full">
              ...
              <div className="mt-4 flex justify-between">
                ...
                <Button variant="destructive" onClick={() => handleDelete(volunteer.id)}>Delete</Button>
              </div>
            </div>
          ))
        )}
